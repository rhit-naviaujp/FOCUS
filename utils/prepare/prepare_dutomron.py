...
def create_instance_dataset(dataset_dir, output_dir):
    ...
    """
    image_dir = os.path.join(dataset_dir, f"DUT-OMRON-image")
    mask_dir = os.path.join(dataset_dir, "pixelwiseGT-new-PNG")
    ...
    # Save to file
    output_file_path = os.path.join(output_dir, f"DUTOMRON_INSTANCE.json")
...
def create_semantic_dataset(dataset_dir, output_dir):
    ...
    # Save to file
    output_file_path = os.path.join(output_dir, "DUTOMRON_SEMANTIC.json")
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    with open(output_file_path, 'w') as f:
        json.dump(coco_format, f)
...
if __name__ == "__main__":
    ...
    dataset_dir = "datasets/DUTOMRON"  # Update this to the path of your dataset
    output_dir = "datasets/DUTOMRON"  # Update this to your desired output directory

    create_instance_dataset(dataset_dir, output_dir)
    create_semantic_dataset(dataset_dir, output_dir)

    for name in ["pixelwiseGT-new-PNG"]:
