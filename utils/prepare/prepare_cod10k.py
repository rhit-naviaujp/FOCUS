...
def create_instance_dataset(dataset_dir, output_dir, dataset_type):
    ...
    mask_dir = os.path.join(dataset_dir, f"{dataset_type}/GT_Object")
...
if __name__ == "__main__":
    dataset_dir = "datasets/COD10K-v3"  # Update this to the path of your dataset
    output_dir = "datasets/COD10K-v3"  # Update this to your desired output directory
    ...
    for name in ["Train/GT_Object", "Test/GT_Object"]:
        annotation_dir = Path(os.path.join(dataset_dir ,  name))
        output_dir = Path(os.path.join(dataset_dir , "annotations_detectron2" , name.split("/")[0]))
