# -------------------------------------------------------------------------------------------
# Reference: https://github.com/facebookresearch/Mask2Former/blob/main/tools/analyze_model.py
...
def do_flop(cfg):
    if isinstance(cfg, CfgNode):
        ...
        DetectionCheckpointer(model).load(os.path.join("ckpt",cfg.MODEL.WEIGHTS))
    else:
